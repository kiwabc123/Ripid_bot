...
/**
 * Stores all the state for a trade, as described in <a href= "https://docs.coinapi.io/#json-structure">https://docs.coinapi.io/#json-structure</a>.
 * <p>
...
public class Trade {
	...
	/** Aggressor side of the transaction (BUY/SELL/BUY_ESTIMATED/SELL_ESTIMATED/UNKNOWN) */
